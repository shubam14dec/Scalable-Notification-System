...
name: boris
description: |
  111 Claude Code workflow tips from Boris Cherny (creator of Claude Code) and the Claude Code team.
...
## Topic List (111 tips across 99 sections)
...
**111 tips** across 99 topics, sourced from Boris Cherny (creator of Claude Code) and the Claude Code team at Anthropic. All tips are contained in this file — do not fetch from the website.

**Parts:** The tips were shared across 18 threads:
